...
a = torch.rand(4, 3, 28, 28)
print(a)
print(a.index_select(0, torch.tensor([0, 2])).shape)  # 第1个参数的第0和第1个 # torch.Size([2, 3, 28, 28])
print(a.index_select(2, torch.arange(20)).shape)  # torch.Size([4, 3, 20, 28])
